      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: IconButton(
              icon: const Icon(Icons.qr_code_scanner, color: AppColors.buttonColors),
              onPressed: () {
        ...
        children: [
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              items: <String>['Recently Added', 'Alphabetical', 'Calories: High to Low', 'Calories: Low to High']
...
void _showMealDetailsBottomSheet(BuildContext context, String name, String description) {
  showModalBottomSheet(
    ...
    if (value != null) {
      ...
      print('Servings: ${value['servings']}, Serving Size: ${value['servingSize']}');
